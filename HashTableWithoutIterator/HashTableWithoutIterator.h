...
#include "DynamicArrayWithoutIterator.h" //the dynamic array I made is used here for the array of singly linked lists
#include "LinkedListWithIterator.h" //the linked list (with iterator) I made is used here for the chaining
...
public:
    ...
    //I did write them for DynamicArrayWithoutIterator.h, and 
    //LinkedListWithIterator.h both used here for this hash table
